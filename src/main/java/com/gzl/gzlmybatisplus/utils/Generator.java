package com.gzl.gzlmybatisplus.utils;
...
public class Generator {
  ...
  public static void main(String[] args) {
    ...
    dc.setUrl("jdbc:mysql://10.0.1.101:3306/mybatis_plus_gzl?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&useSSL=false");
    dc.setDriverName("com.mysql.cj.jdbc.Driver");
    dc.setUsername("dbtester");
    dc.setPassword("tEst@wiseflY.cn");
    generator.setDataSource(dc);

    // 包配置
    PackageConfig pc = new PackageConfig();
    pc.setParent("com.gzl.gzlmybatisplus");
    pc.setModuleName("basic"); //此处是所属模块名称
//        pc.setEntity("entity"); //默认entity,controller,service,service.impl,mapper,mapper.xml
     ...
     * 将xml生成到resource下面
     */
    String templatePath = "/templates/controller.xml.ftl"; // framemark
    // 自定义输出配置
    ...
    focList.add(new FileOutConfig(templatePath) {
      ...
      public String outputFile(TableInfo tableInfo) {
        ...
        return projectPath + "/src/main/java/com/gzl/gzlmybatisplus/"
                        + pc.getModuleName()
...
//         sc.setExclude(""); //                 不需要生成  二选一
    ...
    sc.setControllerMappingHyphenStyle(true); //默认false
